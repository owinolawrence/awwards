# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2020-01-15 06:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterUniqueTogether(
            name='review',
            unique_together=set([('user', 'design', 'usability', 'content', 'post')]),
        ),
        migrations.AlterIndexTogether(
            name='review',
            index_together=set([('user', 'design', 'usability', 'content', 'post')]),
        ),
    ]
